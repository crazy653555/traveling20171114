...
export class IgComponent implements OnInit {
  ...
  data = [
    ...
    },
    {
      id:2,
     name:'Delilahwong',
      content:'Delilah Wong The past and present exist for the future Toast To life。 過去成就未來，把握當下，紀錄每一天',
    ...
    },
    {
      id:4,
     name:'My6birds',
      content:'Y-H Wu My 4 greencheek conures🐧(Marvel🚹Stark🚹Packer🚹Groot🚺),and 2 lovebirds 🐤（Hulk🚹Thor🚹）我的四隻綠頰小太陽和兩隻愛情鳥',
